...
export default function FillInTheBlankQuestionEditor({questionId, updateQuestionValue}: {
    questionId: number;
    ...
    <div className="mb-3 justify-content-center">
        ...
        <div className="row mb-1">
            <h5>Answers (All answers are correct)</h5>
        </div>
        {question.answers.map((a: any, index: number) => {
            if (!a.selected) return (<div className="row m-2">
