...
export default function KanbasNavigation() {
  return (
    <div id="wd-kanbas-navigation">
      <a href="https://northeastern.edu/" id="wd-neu-link" target="_blank">
        Northeastern
      </a> <br />
      ...
      <Link to="/Kanbas/Inbox" id="wd-indbox-link">Inbox</Link> <br />
      <Link to="/Labs" id="wd-account-link">Labs</Link> <br />
    </div>
  );
}